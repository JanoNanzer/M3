...
async function problemA () {
  ...
  // AsyncAwait version
  const poemA = await promisifiedReadFile('poem-one/stanza-01.txt');
  blue(poemA);
...
async function problemB () {
  ...
  // AsyncAwait version
  let poem2 = await promisifiedReadFile('poem-one/stanza-02.txt')
  let poem3 = await promisifiedReadFile('poem-one/stanza-03.txt')
  blue(poem2)
  blue(poem3)
...
async function problemD () {
  ...
  // AsyncAwait version
  // let poem4 = await promisifiedReadFile('poem-one/wrong-file-name.txt')
  try {
...
async function problemF () {
  ...
  try {
    blue(await promisifiedReadFile('poem-one/stanza-03.txt'))
    blue(await promisifiedReadFile('poem-one/wrong-file-name.txt'))
    // console.log('done') -> peor
  } catch (error) {
    magenta(error)
    // console.log('done') -> peor
  } finally{
    console.log('done') /* -> forma segura */
  }
  // console.log('done') -> forma basica
